...
console.log();
//Obtener el valor mínimo y máximo de un conjunto de números
const numeros = [-10, 12, 20, 3, -2, 8, 5];
console.log(`Numero menor : ${Math.min(...numeros)} numero Mayor : ${Math.max(...numeros)}`);
console.log()
//calcular la raiz cuadrada  de un numero con Math.sqrt
